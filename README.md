...
- [10/100 PM需要并行管理多个项目么？](#10100-pm需要并行管理多个项目么)
...
## 10/100 PM需要并行管理多个项目么？

```
最近由于公司的运营需求，需要部分PM同时兼管多信项目，问题：PM需要/可以同时并行管理多个项目么？
```

依据自己的个人经验：交付型项目经理分为两种沉浸式/非沉浸式项目经理。
- 沉浸式项目经理：在管理团队的同时会深入到项目内部的业务上下文，学习并引导客户完成价值交付。
- 非沉浸式项目经理：仅做项目的团队管理，不会触碰业务相关。

如果基于上面这种划分方法，那么：
- `非沉浸式项目经理`可以同时管理多个项目，项目经理的带宽是允许的
- `沉浸式项目经理`由于要了解业务，带宽通常是不够的
